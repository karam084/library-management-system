class BooksController < ApplicationController
    ...
    before_action :authenticate_student!, only: [:checkout, :getStudentBookFine, :getOverdueBooks, :viewHoldRequestForLibrarian, :viewBookHistory, :returnBook, :bookmark, :unbookmark, :requestBook, :repealRequest, :getBookmarkBooks, :list_checkedoutBooks]
